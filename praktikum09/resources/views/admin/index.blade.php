...
<head>
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="{{assest('assest/css/adminlte.min.css')}}">
</head>
...
<!-- AdminLTE App -->
<script src="{{assest('assest/js/adminlte.min.js')}}"></script>
<!-- AdminLTE for demo purposes -->
<script src="{{assest('assest/js/demo.js')}}"></script>
</body>
</html>